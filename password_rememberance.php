                    	...
                    	<div class="panel-body">
                            ...
                            if(isset($_POST['btn_insert']))
                            {
                              ...
                              ('$id','$question','$answer')";
                                ...
                                <p><i class=\"glyphicon glyphicon-ok\"></i>&nbsp; <b> Registered Successfully </b>
                               <a href='login.php' class='btn btn-info'>Login here</a> </p> 
                                </div>";
//
                                }
                                else
                                {
                                    die( "<b> <font color='red'>something went wrong! try again</font> </b>");
